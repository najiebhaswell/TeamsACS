...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 relative overflow-hidden">
            ...
            <Card className="w-full max-w-md mx-4 bg-surface/80 border-surface-border/50 backdrop-blur-xl shadow-2xl">
                <CardHeader className="text-center space-y-4">
                    <div className="mx-auto w-16 h-16 rounded-2xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-lg shadow-blue-500/25">
                        <Wifi className="w-8 h-8 text-on-surface" />
                    </div>
                    <div>
                        <CardTitle className="text-2xl font-bold text-on-surface">TeamsACS</CardTitle>
                        <CardDescription className="text-on-surface-secondary mt-1">TR-069 Auto Configuration Server</CardDescription>
                    </div>
                </CardHeader>
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="username" className="text-on-surface-secondary">Username</Label>
                            <Input
                                id="username"
                                type="text"
                                ...
                                className="bg-surface-input border-slate-600 text-on-surface placeholder:text-on-surface-muted focus-visible:ring-blue-500"
                                required
                            />
                        </div>
                        <div className="space-y-2">
                            <Label htmlFor="password" className="text-on-surface-secondary">Password</Label>
                            <Input
                                id="password"
                                type="password"
                        ...
                        <Button
                            type="submit"
                            className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-on-surface shadow-lg shadow-blue-500/25 transition-all duration-200"
                            disabled={loading}
                        >
                            {loading ? (
                                <>
